...
import com.example.teacherservice.docs.student.AddStudentDoc;
import com.example.teacherservice.docs.student.DeleteStudentDoc;
import com.example.teacherservice.docs.student.GetStudentDoc;
...
public class StudentController {
    ...
    @GetMapping("/getList")
    @Validated
    public ResponseEntity<List<StudentDto>> getAllStudents(@RequestParam String name, @RequestParam int course) {
